...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%"
	...
	max-width: 560px;"
			...
			font-family: sans-serif;"
                    ...
                    <!-- SUBHEADER -->
                    <!-- Set text color and font family ("sans-serif" or "Georgia, serif") -->
                    <tr style="border: #127DB3 solid 1px;">
                        <td align="center" valign="top"
			...
			font-family: sans-serif;"
                            class="subheader">
                            Usuario: &nbsp;{{ $dataReq->name }}
                            <br>
                            Email: &nbsp;{{ $dataReq->email }}
                            <br>
                            Telefono: &nbsp;{{ $dataReq->phone }}
                        </td>
                    </tr>
			...
			font-family: sans-serif;"
                            class="paragraph">
                            Tienes alguna&nbsp;pregunta? <a href="mailto:support@ourteam.com" target="_blank"
                                style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">asociadosrmb@gmail.com</a>
                        </td>
                    </tr>
                            ...
                            <table width="256" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="middle"
                                        ...
                                        <a target="_blank"
                                            href="https://web.facebook.com/profile.php?id=61551742844411"
                                    ...
                                    <td align="center" valign="middle"
                                        style="margin: 0; padding: 0; padding-left: 10px; padding-right: 10px; border-collapse: collapse; border-spacing: 0;">
                                        <a target="_blank"
                                            href="https://www.instagram.com/rmbconsultoresasocidos/"
                                            style="text-decoration: none;"><img border="0" vspace="0"
                                                hspace="0"
                                                style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
					                            color: #000000;"
