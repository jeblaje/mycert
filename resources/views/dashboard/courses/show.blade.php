    ...
    <div class="container px-4">
        ...
        <x-section-title class="flex px-2 mb-4 py-6">
            ...
            <x-slot name="description">
                ...
                <button type="button" class="btn btn-info mt-2" data-bs-toggle="modal" data-bs-target="#CreateCertf"
                    style="color: #000;">
                    <i class="fa fa-file" style="margin-right: 4px;"></i>
                    <span span> Nuevo certificado </span>
                </button>
                <br>
                ...
                <!-- Modal -->
                <div class="modal fade" id="CreateCertf" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                    ...
                    @foreach ($student->files as $file)
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <button type="button" class="bg-gray-300 hover:bg-gray-400 text-gray-800 text-warning font-bold py-2 px-4 rounded inline-flex items-center" data-bs-toggle="modal" data-bs-target="#editCertf-{{$file->id}}"
                                    style="color: #000;">
                                    <i class="fa fa-pen" style="margin-right: 4px;"></i>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="editCertf-{{$file->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-lg-4>
                                                    <label for="Name" class="form-label">Dia</label>
                                                    <input value="{{ old('day', $file->day) }}" name="day" type="number"
                                                        class="form-control @error('day') is-invalid @enderror" id="Name">
                                                    @error('day')
                                                        <div id="Emailfeedback" class="invalid-feedback">
                                                            {{ $message }}
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <option value="1" @selected('1' == $file->month)>Enero</option>
                                                    <option value="2" @selected('2' == $file->month)>Febrero</option>
                                                    <option value="3" @selected('3' == $file->month)>Marzo</option>
                                                    <option value="4" @selected('4' == $file->month)>Abril</option>
                                                    <option value="5" @selected('5' == $file->month)>Mayo</option>
                                                    <option value="6" @selected('6' == $file->month)>Junio</option>
                                                    <option value="7" @selected('7' == $file->month)>Julio</option>
                                                    <option value="8" @selected('8' == $file->month)>Agosto</option>
                                                    <option value="9" @selected('9' == $file->month)>Sectiembre</option>
                                                    <option value="10" @selected('10' == $file->month)>Octubre</option>
                                                    <option value="11" @selected('11' == $file->month)>Noviembre</option>
                                                    <option value="12" @selected('12' == $file->month)>Diciembre</option>
                                                    </select>
                                                </div>

                                                <div class="mb-3 col-lg-4>
                                                    <label for="Name" class="form-label">Year</label>
                                                    <input value="{{ old('year', $file->year) }}" name="year" type="number"
                                                        class="form-control @error('year') is-invalid @enderror" id="Name">
                                                    @error('year')
                                                        <div id="Emailfeedback" class="invalid-feedback">
                                                            {{ $message }}
